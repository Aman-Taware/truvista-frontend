...
const CreatePropertyPage = () => {
  ...
  const handleConfirmationResult = (addMedia) => {
    setShowConfirmModal(false);
    if (addMedia && createdPropertyId) {
                ...
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      <h3 className="text-lg leading-6 font-medium text-gray-900">Add Media for Property</h3>
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Would you like to add images, brochures, or layouts to this property now?
                        </p>
                      </div>
                    </div>
                  </div>
